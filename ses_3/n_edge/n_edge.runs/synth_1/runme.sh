...
HD_PWD='C:/Users/Admin/Desktop/FPGA_FOLDER/ses_3/n_edge/n_edge.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neg_edge_det.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neg_edge_det.tcl
