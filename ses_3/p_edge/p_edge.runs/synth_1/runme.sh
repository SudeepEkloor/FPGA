...
HD_PWD='C:/Users/Admin/Desktop/FPGA_FOLDER/ses_3/p_edge/p_edge.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pos_edge_det.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pos_edge_det.tcl
