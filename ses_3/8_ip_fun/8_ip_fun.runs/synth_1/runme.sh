...
HD_PWD='C:/Users/Admin/Desktop/FPGA_FOLDER/ses_3/8_ip_fun/8_ip_fun.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_func8_with_reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source logic_func8_with_reg.tcl
