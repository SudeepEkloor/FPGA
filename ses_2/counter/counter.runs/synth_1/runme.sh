...
HD_PWD='C:/Users/Admin/Desktop/FPGA_FOLDER/ses_2/counter/counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log three_bit_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source three_bit_counter.tcl
