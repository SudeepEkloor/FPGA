...
HD_PWD='C:/Users/Admin/Desktop/FPGA_FOLDER/ses_2/and_1/and_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and_using_dff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and_using_dff.tcl
